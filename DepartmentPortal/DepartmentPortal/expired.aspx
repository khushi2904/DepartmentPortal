<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="expired.aspx.cs" Inherits="DepartmentPortal.expired" %>
...
<body>
    ...
    <div>
        ...
        <div class="container text-center">
            <h3>Session Expired. Click <a href="Default.aspx">here</a> to go back to Home.</h3>
        </div>
    </div>
